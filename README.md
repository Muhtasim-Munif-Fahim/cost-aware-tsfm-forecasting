...
> The manuscript itself, its LaTeX source and the journal template are **not included**
> in this public repository, which carries the code and results only. The
...
[`paper/RESULTS_LEDGER.md`](paper/RESULTS_LEDGER.md)):
...
[`CITATION.cff`](CITATION.cff). The archived snapshot is at [10.5281/zenodo.22118240](https://doi.org/10.5281/zenodo.22118240).
